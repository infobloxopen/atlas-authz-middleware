...
func (_m *MockOption) Execute(c *Client) {
	_m.Called(c)
}
...
func (_c *MockOption_Execute_Call) Run(run func(c *Client)) *MockOption_Execute_Call {
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*Client)) *MockOption_Execute_Call {
	_c.Call.Return(run)
	return _c
}
